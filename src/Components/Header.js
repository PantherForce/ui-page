...
const Header = () => {
    return (
        <div className='pt-[73px] bg-[#F6F6F6] sm:pl-16 pl-4'>
            <div>
                <div className='flex flex-col-reverse sm:flex-row items-center justify-between'>
                    <div className='sm:w-[30%] w-[100%] p-4 flex flex-col items-center sm:items-start'>
                        <p className='text-xl font-semibold my-3 text-[#12406F]'>Lorem Ipsum</p>
                        ...
                        <button className='my-4 bg-[#12406F] text-white px-3 py-2 rounded-md flex'>
